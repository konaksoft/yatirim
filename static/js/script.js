$(document).ready(function () {
    ...
    $('#wizard').submit(function (e) {
        alert("selam");
        if ($("#wizard")[0].checkValidity() === false) {
        ...
        $.ajax({
            ...
            success(data) {
                if (data.result === true) {
                    Swal.fire({
                        title: 'Uyarı',
                        html: "İletişim Formu Gönderildi",
                        type: 'success',
                    ...
                    Swal.fire({
                        title: 'Hata',
                        html: 'Sistemde kayıtlı daha önceden bir mesajınız bulunmaktadır.' +
                            'Lütfen farklı bir mail adresi ile iletişime geçin. ',
                        type: 'error',
                        showCancelButton: false,
                        confirmButtonText: 'Ok'
                    });
                    $("#btnSave").prop("disabled", false).html("Kaydet");
